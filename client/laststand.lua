        ...
        CreateThread(function()
            while InLaststand do
                ...
                elseif LaststandTime - 1 <= 0 then
                    ...
                    TriggerServerEvent("qb-log:server:CreateLog", "death", GetPlayerName(player) .. " ("..GetPlayerServerId(player)..") öldü", "red", "**".. killerName .. "** Öldürüldü  ".. GetPlayerName(player) .." Birlikte **".. weaponLabel .. "** (" .. weaponName .. ")")
                    deathTime = 0
                    OnDeath()
                    DeathTimer()
                end
...
RegisterNetEvent('hospital:client:HelpPerson', function(targetId)
    ...
    QBCore.Functions.Progressbar("hospital_revive", "Kişiye Tıbbi Müdahale Ediliyor..", 60000, false, true, {
