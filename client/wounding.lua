...
RegisterNetEvent('hospital:client:UseBandage', function()
    ...
    QBCore.Functions.Progressbar("use_bandage", "Bandaj Kullanıyorsun..", 4000, false, true, {
...
RegisterNetEvent('hospital:client:UsePainkillers', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("use_bandage", "Ağrı Kesici Kullanıyorsun..", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
