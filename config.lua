...
Config.Locations = {
    ...
    ["duty"] = {
        [1] = vector3(311.3837, -594.043, 43.284),
       -- [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        [1] = vector4(297.07, -604.83, 43.23, 68.31),
      --  [2] = vector4(-234.28, 6329.16, 32.15, 222.5),
    },
    ["helicopter"] = {
        [1] = vector4(351.6149, -587.708, 74.161, 160.5),
       -- [2] = vector4(-475.43, 5988.353, 31.716, 31.34),
    },
    ["armory"] = {
        [1] = vector3(303.71, -600.73, 43.28),
    ...
    ["main"] = {
        [1] = vector3(332.2877, -595.779, 43.284),
    },
    ["altkat"] = {
        [1] = vector3(344.3661, -586.238, 28.796),
    },
    ["stash"] = {
        [1] = vector3(306.74, -601.56, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(366.51, -581.65, 43.11, 67.88), taken = false, model = 1631638868},
       [2] = {coords = vector4(361.36, -581.29, 43.11, 68.97), taken = false, model = 1631638868},
       [3] = {coords = vector4(364.95, -585.94, 43.1, 67.88), taken = false, model = 1631638868},
       [4] = {coords = vector4(337.03, -575.1, 44.19, 154.77), taken = false, model = -289946279},
       [5] = {coords = vector4(357.39, -598.36, 43.99, 153.89), taken = false, model = -1091386237},
    ...
    ["stations"] = {
        [1] = {label = "Pillbox Hastanesi", coords = vector4(304.27, -600.33, 43.28, 272.249)}
    }
}

Config.UMBeds = {
    vector4(307.92, -581.55, 44.2, 339.27),
    vector4(311.22, -582.78, 44.2, 330.5),
    vector4(314.66, -584.13, 44.2, 342.82),
    vector4(317.82, -585.25, 44.2, 337.55),
    vector4(322.78, -586.99, 44.2, 340.17),
    vector4(324.17, -582.9, 44.2, 159.21),
    vector4(319.2, -581.36, 44.2, 162.0),
    vector4(313.65, -579.31, 44.2, 158.12),
    vector4(309.1, -577.73, 44.2, 158.45),
    vector4(326.87, -570.87, 44.26, 156.91),
    vector4(321.14, -568.82, 44.26, 159.46),
    vector4(326.84, -570.85, 44.26, 158.93),
    vector4(327.01, -570.54, 44.2, 150.77)
}
...
Config.MaxInjuryChanceMulti = 0
Config.ForceInjury = 0
Config.AlwaysBleedChance = 0

--[[
    Message Timer : How long it will take to display limb/bleed message
]]
Config.MessageTimer = 60
...
Config.HeadInjuryChance = 100
Config.ArmInjuryChance = 100
...
Config.MajorArmoredBleedChance = 0
...
Config.DamageMinorToMajor = 100

--[[
    AlertShowInfo :
]]
Config.AlertShowInfo = 99999
